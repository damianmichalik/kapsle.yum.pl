 ...
 */
class Cap extends \AppBundle\Entity\Cap implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'slug', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'image', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'imageFile', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'imageTemp', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'createDate', '' . "\0" . 'AppBundle\\Entity\\Cap' . "\0" . 'updateDate', 'brewery'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cap $proxy) {
    ...
    public function setBrewery(\AppBundle\Entity\Brewery $brewery = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBrewery', [$brewery]);

        return parent::setBrewery($brewery);
    }
    ...
    public function getBrewery()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBrewery', []);

        return parent::getBrewery();
    }
