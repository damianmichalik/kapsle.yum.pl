 ...
 */
class Configuration extends \AppBundle\Entity\Configuration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Configuration' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Configuration' . "\0" . 'key', '' . "\0" . 'AppBundle\\Entity\\Configuration' . "\0" . 'value'];
        }
