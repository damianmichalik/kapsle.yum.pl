 ...
 */
class Subscriber extends \AppBundle\Entity\Subscriber implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Subscriber' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Subscriber' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Subscriber' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Subscriber' . "\0" . 'actionToken', '' . "\0" . 'AppBundle\\Entity\\Subscriber' . "\0" . 'confirmed', '' . "\0" . 'AppBundle\\Entity\\Subscriber' . "\0" . 'registerDate'];
        }
